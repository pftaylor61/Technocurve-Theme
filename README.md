# The Technocurve Theme

## Version 0.0.1

In the information below, copied from the ClassicPress theme, you will see that the authors gave permission for the theme to be used as a Starter theme, being completely edited. I have chosen to take this course. I have kept the original Readme notes here, but depreciated each heading value.

https://technocurve.com
